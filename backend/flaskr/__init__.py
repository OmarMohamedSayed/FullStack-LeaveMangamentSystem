...
def create_app(test_config=None):
  ...
  def get_all_pendleavestatus():
    try:
      pend_query = Leavestatus.query.order_by(Leavestatus.id).filter_by(status="pend").all()
  ...
  def delete_pendleavestatus(id):
    ...
    try:
      leave_query = Leavestatus.query.filter_by(id=id).one_or_none()
      leave_query.delete()
  ...
  def update_leavestatus(id):
    ...
    try:
      select_leave = Leavestatus.query.filter_by(id=id)
